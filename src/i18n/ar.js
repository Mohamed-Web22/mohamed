const ar = {
  ...
  about: {
    ...
    overviewText: 'بوابتك المتكاملة للتفوق في الشهادة السودانية.\nقمم منصة تعليمية رائدة تمنحك الأدوات اللازمة للفهم العميق والتحصيل الذكي، من خلال شروحات مرئية، أدلة عملية، ودعم مستمر يرافقك في كل خطوة نحو القمة.',
    vision: { 
      title: 'الرؤية', 
